...
| Pair | Carries | Stub |
|------|---------|------|
| tailscale-query → {network-topology, completion-router} | parsed self+peer status snapshots | `tailscale-status` |
